    ...
    fn current_terminal(&self, token: &Token) -> Option<TerminalId> {
        ...
        match &token.kind {
            ...
            Keyword(kind) => match kind {
                ...
                KeywordKind::Int8 => Some(t.i8_),
                KeywordKind::Int16 => Some(t.i16_),
                KeywordKind::Int32 => Some(t.i32_),
                KeywordKind::Int64 => Some(t.i64_),
                KeywordKind::UInt8 => Some(t.u8_),
                KeywordKind::UInt16 => Some(t.u16_),
                KeywordKind::UInt32 => Some(t.u32_),
                KeywordKind::UInt64 => Some(t.u64_),
                KeywordKind::Usize => Some(t.usize_),
                KeywordKind::Isize => Some(t.isize_),
                KeywordKind::Bool => Some(t.bool_),
                KeywordKind::True => Some(t.true_),
                KeywordKind::False => Some(t.false_),
                ...
                KeywordKind::Struct => Some(t.struct_),
            },
